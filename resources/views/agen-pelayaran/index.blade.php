...
@section('content')
	<div class="ui grid containers">
		<div class="row">
			<div class="left aligned ten wide column">
				<div class="ui one column grid">
					<div class="right aligned column">
						<table class="ui raised {{$paginatedAgenPelayaran->hasMorePages() ? 'stacked' : '' }} segment selectable celled striped fixed table">
							<thead>
								<tr>
							...
							<tbody>
								@if(count($paginatedAgenPelayaran->items()) > 0)
									@foreach ($paginatedAgenPelayaran->items() as $agenPelayaran)
										<tr>
											<td>
												<img src="{{ $agenPelayaran->logo }}" alt="{{ $agenPelayaran->nama }}" style="width:100%">
											</td>
											<td class="data-nama">{{ $agenPelayaran->nama }}</td>
											<td class="data-alamat">{{ $agenPelayaran->alamat }}</td>
											<td class="data-telepon">{{ $agenPelayaran->telepon }}</td>
											<td class="data-loket">{{ $agenPelayaran->loket }}</td>
			...
			<div class="one wide six wide grid column">
				<div class="row">
