<nav class="ui sidebar vertical left menu overlay visible" >
		{{-- style="-webkit-transition-duration: 0.5s; overflow: visible !important;"> --}}
		<div class="item logo">
...
<section class="pusher">
		<header class="ui asd menu borderless" >
		...
		<div>
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore magni tenetur nemo, suscipit repellendus officiis molestias illum fuga sapiente delectus doloribus odio repellat tempore, officia dignissimos. Tenetur magni iure id temporibus sequi illo aliquid distinctio nam itaque cumque, voluptatibus doloremque consequatur vitae veniam ex repudiandae molestiae. Accusamus dolorem, incidunt, suscipit commodi harum blanditiis recusandae obcaecati ab nemo magnam enim in illum minus placeat at? Delectus consectetur magni eaque quae in! Natus reprehenderit exercitationem doloremque non obcaecati laudantium! Nisi similique inventore accusantium illo quos enim ab minus, hic provident sapiente animi, quasi necessitatibus! Corporis soluta deleniti fugit maiores quibusdam odit exercitationem!
		</div>
</section>
<style>
		/* .marginlefting {
